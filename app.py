...
def resize_images(images_to_resize, new_height=640, new_width=640):
    ...
    success, message, skipped_files = image_processor.resize_and_save(
        images_to_resize,
        output_folder,
        new_width,
        new_height
...
with gr.Blocks(theme=theme) as demo:
    ...
    detect_yolo_button.click(detect_yolo_and_classify, inputs=image_for_yolo, outputs=detected_yolo_object_image)
    detect_cnn_button.click(detect_cnn_and_classify, inputs=image_for_cnn, outputs=detected_cnn_object_image)
